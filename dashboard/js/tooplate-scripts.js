...
function drawBarChart() {
  if ($("#barChart").length) {
    ...
    configBar = {
      type: "bar",
      data: {
        labels: ["Paysanduba", "Atlético Maneiro", "Shaktar Dos Lek's", "Inter de Limão", "Baile de Monique", "Barcemlona"],
        datasets: [
          {
            label: "Times",
            data: [12, 19, 3, 5, 2, 3],
